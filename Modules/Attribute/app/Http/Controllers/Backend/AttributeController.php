...
class AttributeController extends BackendController
{
    ...
    public function edit(Request $request)
    {
        try {
            ...
            $languageOptions = $this->getLanguageOptions();
            $optionableInput = ['select', 'checkbox', 'multiselect', 'radio'];
            ...
            return view('attribute::backend.edit', compact('inputTypeOptions', 'yesNoOptions', 'attribute', 'attributeOption', 'optionableInput', 'languageOptions'));
        } catch (\Throwable $e) {
        ...
        try {
            ...
            if (isset($params['delete_ids'])) {
                ...
                foreach ($deleteIdsArray as $deleteId) {
                    ...
                    if (! $attributeOption || $attributeOption->attribute_id != $id) {
                        throw new \Exception(trans('attribute::attribute.messages.data_invalid'));
                    }
