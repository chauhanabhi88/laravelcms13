...
Route::prefix('cron')->group(function() {
    ...
    Route::delete('/schedule/massDelete', [
        'as' => 'admin.cron_schedule.mass_delete',
        'uses' => 'CronController@scheduleMassDelete',
        'middleware' => 'can:admin.cron_schedule.mass_delete'
    ]);
});
