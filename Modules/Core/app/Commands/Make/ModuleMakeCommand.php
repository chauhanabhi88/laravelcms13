...
class ModuleMakeCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $columns = $this->argument('column');
        $translation = $this->argument('translation');
        $softDelete = $this->argument('soft_delete');
        $success = true;
    ...
    {
        return [
            ['column', InputArgument::OPTIONAL, 'The names of modules will be created.'],
            ['translation', InputArgument::OPTIONAL, 'The names of modules will be created.'],
            ['soft_delete', InputArgument::OPTIONAL, 'The names of modules will be created.'],
