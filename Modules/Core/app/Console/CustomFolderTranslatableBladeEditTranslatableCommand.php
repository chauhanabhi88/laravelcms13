...
class CustomFolderTranslatableBladeEditTranslatableCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-folder-translatable-blade-edit-translatable';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . '/resources/views/backend' . '/' . $this->argument('lower_name') . '/partials/edit-translatable-fields.blade.php';
    }
