...
class CustomFolderTranslatableBladeEditCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-folder-translatable-blade-edit';
    ...
    private function getStubName()
    {
        ...
        $stub = '/views/backend/translatable_folder-edit.stub';
