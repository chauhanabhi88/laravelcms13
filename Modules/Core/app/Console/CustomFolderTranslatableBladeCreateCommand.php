...
class CustomFolderTranslatableBladeCreateCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-folder-translatable-blade-create';
    ...
    private function getStubName()
    {
        ...
        $stub = '/views/backend/translatable_folder-create.stub';
