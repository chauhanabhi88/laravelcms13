...
class CustomFolderTranslatableCreateRequestCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-folder-translatable-create-request';
    ...
    private function getStubName()
    {
        ...
        $stub = '/scaffold/translatable_folder-create-request.stub';
