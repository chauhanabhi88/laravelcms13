...
class CustomFolderTranslatableUpdateRequestCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-custom-folder-translatable-update-request';
    ...
    public function getDestinationFilePath()
    {
        ...
        return $path . '/app/Http/Requests' . '/Update' . $this->getTableName() . 'Request.php';
    }
    /**
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub($this->getStubName(), [
            ...
            'UPDATE_TRANSLATABLE_MESSAGES' =>  $this->argument('request_translatable_messages'),
        ]))->render();
    }
    /**
    ...
    private function getStubName()
    {
        ...
        $stub = '/scaffold/translatable_folder-update-request.stub';
