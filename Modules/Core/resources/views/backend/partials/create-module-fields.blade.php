{{ formStart(null,"POST" ,'admin.module.createmodule' ,updateUrlParams(), ['id' => 'clear_cache'])}}
<div class="row">
        ...
        <div class="card card-info card-outline card-outline-tabs">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" catalog="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-three-catalog-info-tab" data-toggle="pill" href="#custom-tabs-three-catalog-info" catalog="tab" aria-controls="custom-tabs-three-catalog-info" aria-selected="true">{{ trans("core::core.titles.module_info") }}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-three-catalog-info" catalog="tabpanel" aria-labelledby="custom-tabs-three-catalog-info-tab">
                        <div class="row">
                            <div class="col-md-6">
                                {{ normalText("module_name","core::core.labels.module_name", $errors,null,["class" => "form-control required", "placeholder" => "core::core.labels.module_name"])}}
                            </div>
                            <div class="col-md-6">
                        ...
                        @if($moduleType == 2)
                        {{ normalInputOfType("hidden","translatable_module", 'core::core.labels.translatable_module',$errors,1,['hide_label' => true])}}
                        @endif
                    </div>
                </div>
            </div>
