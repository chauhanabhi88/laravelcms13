...
class LanguageController extends BackendController
{
    ...
    public function __construct(LanguageRepository $language, ModuleRepository $module, Filesystem $finder)
    {
        parent::__construct();
    ...
    public function importTranslation(Request $request)
    {
        try {
            ...
            foreach ($collection as $value) {
                ...
                $module = $this->resolveModuleName($value['module'], $modules);
                $file = $this->sanitizeFileName(basename($value['file'], '.php'));
                if (! $module || ! $file) {
                    continue;
                }
                $file = $file.'.php';
