...
<link rel="manifest" href="{{ route('manifest',updateUrlParams(['type' => config('core.route_type')])) }}">
...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/modules/laravelpwa/js/serviceworker.js', {
            scope: '/modules/laravelpwa/js/'
