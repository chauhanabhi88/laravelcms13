...
class DeletedCustomerController extends BackendController
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('customer::backend.deletedcustomergrid', compact('request', 'collection', 'columns', 'filters', 'statusOptions', 'activeMenuId'));
        } catch (\Throwable $e) {
    ...
    public function filters(Request $request)
    {
        try {
            ...
            $activeMenuId = getActiveMenuId($request, 'admin.customer.deletedCustomer');
            $columns = getColumnObject()->getColumns($activeMenuId);
            $content = view('customer::backend.partials.deletedcustomergrid', compact('request', 'collection', 'columns', 'filters', 'statusOptions', 'activeMenuId'));
