...
@section('title')
{{ trans("customer::customer_group.titles.create_customer_group") }}
@endsection
...
<div class="page-title-header row d-none d-sm-flex">
  <div class="page-header col-sm-12 d-flex pb-4 pt-2">
    <div class="col-sm-6">
      <h4 class="page-title">{{ trans("customer::customer_group.titles.create_customer_group") }}</h4>
    </div>
    <div class="col-sm-6">
...
<div class="container-fluid">
  <!-- form start -->
  {{ formStart(null,"POST" ,'admin.customer.group.store' ,updateUrlParams(), ['id' => 'main_form','enctype'=>'multipart/form-data'])}}
      ...
      <div class="card card-info card-outline card-outline-tabs">
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane ctab-panen active" id="general-form">
              <div class="row">
                <div class="col-lg-12">
                  <div class="tab-content">
                    @include('customer::backend.customer_group.partials.create-fields')
                  </div>
                </div>
              </div>
            </div>
