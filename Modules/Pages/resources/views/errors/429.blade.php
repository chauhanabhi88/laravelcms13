                    ...
                    <div class="col-lg-7 mx-auto text-white">
                        <div class="row align-items-center d-flex flex-row">
                            ...
                            <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                                <h2>TOO MANY REQUESTS!</h2><h3 class="font-weight-light">You have made too many attempts. Please wait a few minutes and try again.</h3>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-12 mt-xl-2">
                                <p class="text-white font-weight-medium text-center">Copyright © {{ now()->year }} All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
