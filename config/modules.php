...
return [
    ...
    */
    'stubs' => [
        'enabled' => true,
        'path' => base_path('Modules/Core/app/Commands/stubs'),
        'files' => [
            ...
            'scaffold/controller' => 'app/Http/Controllers/Backend/IndexController.php',
            'scaffold/create-request' => 'app/Http/Requests/CreateRequest.php',
            'scaffold/update-request' => 'app/Http/Requests/UpdateRequest.php',
            'views/backend/index' => 'resources/views/backend/index.blade.php',
            'views/backend/create' => 'resources/views/backend/create.blade.php',
            'views/backend/edit' => 'resources/views/backend/edit.blade.php',
            'views/backend/partials/grid' => 'resources/views/backend/partials/grid.blade.php',
        ...
        'replacements' => [
             ...
             */
            'routes/backend' => ['LOWER_NAME', 'STUDLY_NAME', 'PLURAL_LOWER_NAME', 'KEBAB_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            ...
            'scaffold/permissions' => ['LOWER_NAME'],
            'scaffold/create-request' => ['LOWER_NAME', 'STUDLY_NAME', 'CREATE_RULES', 'REQUEST_FUNCTIONS', 'REQUEST_MESSAGES'],
            'scaffold/update-request' => ['LOWER_NAME', 'STUDLY_NAME', 'UPDATE_RULES', 'REQUEST_FUNCTIONS', 'REQUEST_MESSAGES'],
            'views/backend/index' => ['LOWER_NAME', 'STUDLY_NAME'],
            'views/backend/create' => ['LOWER_NAME', 'STUDLY_NAME', 'CREATE_FIELDS', 'SCRIPTS'],
            'views/backend/edit' => ['LOWER_NAME', 'STUDLY_NAME', 'EDIT_FIELDS', 'SCRIPTS'],
            'views/backend/partials/grid' => ['LOWER_NAME', 'STUDLY_NAME', 'COLUMN_COUNT', 'DATA'],
            'composer' => [
                'LOWER_NAME',
                'STUDLY_NAME',
                'VENDOR',
